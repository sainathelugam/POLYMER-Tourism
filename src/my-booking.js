...
flex-direction: column;
 ...
 <nav>
   ...
   <h2>Date of Booking:
     <iron-input><input placeholder="type-date" required  always-float-label type="date"></iron-input></h2>
    ...
    handleClick() {
        ...
        // localStorage.setItem("firstname", JSON.stringify(myObj));
        ...
        if (this.UserName == '' && this.email == '' && this.phone == '') {
            ...
            sessionStorage.setItem("bookingList", JSON.stringify(this.registerData));
