...
class MyDashboard extends PolymerElement {
    ...
    static get is() { return 'bookinglist'; }


    static get properties() {
        let bookingData = sessionStorage.getItem('bookingList');
        console.log(bookingData);
        console.log(typeof(bookingData))
        let json_bookingData = JSON.parse(bookingData)
        console.log(json_bookingData.firstname);
        console.log(json_bookingData.Email);
        console.log(json_bookingData.phonenumber);
        return {
            bookingDataNew: {
                value() {
                    return [
                        { firstname: "test_name", Email: "TstEmail", phonenumber: "1234324" }
                    ];
                }
            }
        };
